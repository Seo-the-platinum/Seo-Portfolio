...
const About = () => {
  ...
  // height: '140%', width: '50%',left:'25%', top:'-20%'
  return (
    <div className='relative group p-0.5 mt-8 overflow-hidden hover:scale-110 transition-hover duration-500 rounded'id='about'>
      <div className='absolute group-hover:animate-spin-slow dark:group-hover:bg-gradient-to-r from-violet-900 to-emerald-400 opacity-60
        ...
        dark:group-hover:brightness-125 dark:group-hover:blur
         transition-all duration-1000' style={windowSize > 768 ? {height: '50%', width: '110%', left: '-5%', top: '25%'} : {height: '140%', width: '50%',left:'25%', top:'-20%'}}/>
      <div className='flex flex-col relative p-4 dark:bg-[#150726] rounded  group-hover:duration-500 transition-all duration-1000 md:flex-row md:items-center'>
        <div>
