...
const About = () => {
  ...
  return (
    <div className='relative group p-0.5 overflow-hidden sm:hover:scale-110 transition-hover duration-500 rounded md:mt-4'id='about'>
      ...
      <Link className='flex flex-col relative p-4 dark:bg-[#150726] bg-cyan-100 rounded group-hover:duration-500 transition-all duration-1000 md:flex-row' href='/aboutDetails'>
        <div className='flex flex-col md:gap-8'>
          <h1 className='dark:text-emerald-500 text-5xl py-4 md:py-0 text-sky-800'>{`Eliseo Flores`}</h1>
